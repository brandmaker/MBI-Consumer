 ...
 * This maps the signature algorithm string like "rsa-sha256" to the internal JVM algorithm specifier and by the way checks whether the given algorithm is supported.
 *
 * @author axel.amthor
 *
 */
public enum Algorithms {
    ...
    private static final Map<String, Algorithms> aliases = new HashMap<String, Algorithms>();

    static {
        for (final Algorithms algorithm : Algorithms.values()) {
    ...
    Algorithms(final String jvmName, final String portableName, final Class type) {
    ...
    public static String toPortableName(final String name) throws UnsupportedAlgorithmException {
        return get(name).getPortableName();
    }

    public static String toJvmName(final String name) throws UnsupportedAlgorithmException {
        return get(name).getJvmName();
    }

    public static Algorithms get(final String name) throws UnsupportedAlgorithmException {
        final Algorithms algorithm = aliases.get(normalize(name));
